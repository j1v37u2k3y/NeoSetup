# 🚀 Changelog (Legacy / Archived)

> **This is the frozen, hand-curated changelog for NeoSetup through v2.0.0.**
> It is kept for its release narrative, migration notes, and known issues.
> The **active** changelog is [`/CHANGELOG.md`](../../CHANGELOG.md), generated by
> Commitizen from Conventional Commits. New releases are recorded there.
